    ...
    switch(GetMessageTypeFromPacket(event.packet)) {
        case 2: {
            ...
            if (includeStr(packetText, "requestedName|", event.packet->dataLength - 5)) {
                ...
                loginInfo[findArray(loginInfo, "platformID|")] = CatchMessage("platformID|1", currentInfo.meta);
                loginInfo[findArray(loginInfo, "vid|")] = CatchMessage("vid|B771FFA7-F85F-4D9E-8ECC-67585257F5A2", currentInfo.rid);
                loginInfo[findArray(loginInfo, "rid|")] = CatchMessage("rid|01CA055A2B0D55780B804F91F5FF3458", currentInfo.rid);
